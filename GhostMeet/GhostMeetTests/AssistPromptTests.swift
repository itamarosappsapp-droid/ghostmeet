...
struct AssistPromptTests {
    ...
    func codeIsExemptFromPronunciationBrackets() {
        ...
        #expect(system.contains("В блоке кода скобок не ставь: код не произносят."))
    }
