...
/// behind the protocol and a made-up model behind that: the scenarios below run
/// the whole path from a frame of audio to a word in the transcript without a
/// byte leaving the machine.
@MainActor
private struct RecognitionFixture {
